...
namespace EventTicketing.Api.Migrations
{
    ...
    [Migration("20260814025044_AddStripePaymentIntentIdToOrders")]
    partial class AddStripePaymentIntentIdToOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventTicketing.Api.Models.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EventTicketing.Api.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EndTime = new DateTime(2026, 5, 2, 23, 0, 0, 0, DateTimeKind.Unspecified),
                            EventType = "Music",
                            ImageUrl = "https://images.unsplash.com/photo-1516280440614-37939bbacd81?w=800&q=80",
                            Price = 20.00m,
                            StartTime = new DateTime(2026, 5, 2, 20, 30, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("EventTicketing.Api.Models.IdempotencyKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("EventTicketing.Api.Models.OutboxMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
